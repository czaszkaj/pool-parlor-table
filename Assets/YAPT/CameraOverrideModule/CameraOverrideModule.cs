...
namespace YAPT
{
    ...
    public class CameraOverrideModule : UdonSharpBehaviour
    {
        ...
        [SerializeField] private GameObject[] bounds;   // TODO: exaplin what this is
        ...
        public void _SetRenderMode(RenderMode newRenderMode)
        {
        ...
        private void updateCamera()
        {
            ...
            else if (renderMode == RenderMode.VR)
            {
            ...
            else if (renderMode == RenderMode.Desktop)
            {
                if (targetCamera == null) return;
