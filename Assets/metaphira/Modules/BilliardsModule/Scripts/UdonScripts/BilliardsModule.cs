...
public class BilliardsModule : UdonSharpBehaviour
{
    ...
    {
        _LogInfo("processing latest remote state (packet=" + managers.networkingManager.packetIdSynced + ", state=" + managers.networkingManager.stateIdSynced + ")");
...
public void _RedrawDebugger() { }
    ...
    private void redrawDebugger()
    {
        ...
        output += Networking.IsOwner(Networking.LocalPlayer, managers.networkingManager.gameObject) ?
        ...
        VRCPlayerApi currentOwner = Networking.GetOwner(managers.networkingManager.gameObject);
