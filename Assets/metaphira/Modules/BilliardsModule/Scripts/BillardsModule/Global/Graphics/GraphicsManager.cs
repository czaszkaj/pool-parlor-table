...
{
    // TODO: Move color setup to table, where rgaphis functions with arguments would be used
    [Header("4 Ball")]
    ...
    public void _InitializeTable()
    {
        ...
        // renderer
        tableMaterial = table.game.table.GetComponent<MeshRenderer>().material; // create a new instance for this table
        tableMaterial.name = " for " + table.gameObject.name;
        table.game.table.GetComponent<MeshRenderer>().material = tableMaterial;
    }
...
int uniform_cue_colour;
    ...
    private void updateNineBallCues()
    {
        ...
        {
            cueBodyRenderers[table.teamIdLocal].material.SetColor(uniform_cue_colour, table.game.table.k_colour_default);
            cueBodyRenderers[table.teamIdLocal ^ 0x1u].material.SetColor(uniform_cue_colour, table.game.table.k_colour_off);
        }
    }
    ...
    public void _UpdateTableColorScheme()
    {
        if (table.game.table.is9Ball)  // 9 Ball / USA colours
        {
            ...
            pColourErr = table.game.table.k_colour_default; // No error effect
