...
public class DesktopManager : UdonSharpBehaviour
{
                    ...
                    if (Input.GetKeyDown(KeyCode.Mouse0))
                    {
                        ...
                        foreach (Collider c in colliders)
                        {
                            if (c != null && c.gameObject != null)
                            {
                                ...
                                {
                                    table.managers.repositionManager._BeginReposition(repositioner);
                ...
                else
                {
                    ...
                    if (isShooting)
                    {
                        ...
                        if (power > 0)
                        {
                            ...
                            table.managers.currentPhysicsManager.SetProgramVariable("inV0", vel);
                            table.managers.currentPhysicsManager.SendCustomEvent("_ApplyPhysics");
    ...
    private void stopRepositioning()
    {
        ...
        if (currentRepositioner != null)
        {
            table.managers.repositionManager._EndReposition(currentRepositioner);
